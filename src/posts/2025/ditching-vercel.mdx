...
So I’ve [rebuilt gif.land](https://github.com/jonheslop/2026.gif.land), it’s now running on Cloudflare workers. It’s mostly static html but a few routes like [random](https://gif.land/random) and [search](https://gif.land/search) run as edge functions.
